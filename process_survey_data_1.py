...
def process_survey_data_1(model: str):
    ...
    # Code Writer agent: writes complete, runnable scripts
    ...
    # Local executor for running generated Python code
    executor = LocalCommandLineCodeExecutor(
        timeout=10,
        work_dir=out_dir,
    )

    # Code Executor agent: runs code in isolated environment
    ...
    # User agent: represents the human requester in the workflow
    ...
    # ---------------------------
    # Group chat coordination pattern
    # ---------------------------
    pattern = AutoPattern(
        ...
        group_manager_args={
            "llm_config": llm_config,
            # Termination condition: stop when "TERMINATE" is returned
